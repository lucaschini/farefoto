export default function Loc(){
    return(
        <div className="flex flex-col items-center gap-8 pt-10 pb-5 text-black ">
          ...
          <iframe
            ...
            className="w-[80%] md:w-[50%] outline outline-4 rounded-xl outline-black"
          ></iframe>
          <p className="text-xl"> Rua do Rosário, 68 - Centro, Jundiaí</p>
        </div>
    )
}