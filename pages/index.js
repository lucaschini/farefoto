      ...
      <div className="h-screen flex justify-center relative text-black bg-white">
        ...
        <div className="absolute top-20 2xl:top-80 lg:left-14 flex flex-col items-center gap-6 z-20 bg-white lg:max-w-[50%] max-w-[80%] p-9 rounded-2xl ">
          ...
          <p className="lg:text-lg font-medium">
            ...
            tangíveis. <br/>Oferecemos serviços de revelação de alta qualidade para
            que você possa reviver e compartilhar suas histórias mais preciosas.
            Explore nossa variedade de produtos fotográficos e descubra como dar
            vida às suas lembranças. <br/><br/> Revele suas fotos com a gente hoje mesmo!📸
          </p>
          <Link
            href="/catalogo"
